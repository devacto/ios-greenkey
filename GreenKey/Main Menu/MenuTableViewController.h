...
@interface MenuTableViewController : UITableViewController <AuditLightingViewControllerDelegate, AuditResidenceViewControllerDelegate, AuditElectricityTableViewControllerDelegate, AuditHeatingViewControllerDelegate, AuditWaterViewControllerDelegate>
